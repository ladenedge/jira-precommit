...
namespace DigiData.SVN.JiraPrecommit
{
    ...
    /// wants to see the help display.
    /// </summary>
    [Serializable]
    public class HelpOnlyException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HelpOnlyException"/> class.
        /// </summary>
        public HelpOnlyException() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="HelpOnlyException"/>
        /// class with the specified error message.
        /// </summary>
        /// <param name="message">A message that describes the current exception.</param>
        public HelpOnlyException(string message) : base(message) { }
        ...
        public HelpOnlyException(string message, Exception innerException) :
        ...
        protected HelpOnlyException(SerializationInfo info,
