...
namespace DigiData.SVN.JiraPrecommit
{
    ...
    /// </summary>
    [Serializable]
    public class IssueNotFoundException : AtlassianException
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueNotFoundException"/>
        ...
        protected IssueNotFoundException(SerializationInfo info,
